        ...
        <div class="px-4 sm:px-6 lg:px-8 bg-white pt-4">
            ...
            <div class="sm:flex sm:items-center mb-4">
                <div class="sm:flex-auto">
                    ...
                    <p class="mt-2 text-sm text-gray-700">A list of all agents with edit and delete options.</p>
                </div>
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <a href="{{ route('agents.create') }}" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        Create New Agent
                    </a>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    @foreach ($agents as $agent)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $agent->contact_email }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $agent->contact_phone }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('agents.edit', $agent) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
