          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-9 text-center">
              <h1 class="heading" data-aos="fade-up">
                Finest way to find your dream home
              </h1>
              <form
                action="#"
                    ...
                    <div class="property-content">
                      ...
                      <div>
                        ...
                        <div class="specs d-flex mb-4">
                          <span class="d-block d-flex align-items-center me-3">
                            <span class="icon-bed me-2"></span>
                            <span class="caption">1 beds</span>
                          </span>
                          <span class="d-block d-flex align-items-center">
                            <span class="icon-bath me-2"></span>
          ...
          <div class="row">
            ...
            <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="500">
              <div class="box-feature">
                ...
                <p>
                  Empower your property journey with our real estate application, featuring cutting-edge analytics to provide insightful market trends and personalized recommendations for your ideal investment.
                </p>
                <p><a href="#" class="learn-more">Learn More</a></p>
              </div>
            </div>
            <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
              <div class="box-feature">
                ...
                <p>
                  Elevate your property search experience with our real estate application, offering seamless connectivity to experienced agents who are ready to guide you through every step of your journey
                </p>
                <p><a href="#" class="learn-more">Learn More</a></p>
              </div>
            </div>
            ...
            <div class="testimonial-slider">
              ...
              <div class="item">
                <div class="testimonial">
                  ...
                  <blockquote>
                    <p>
                      &ldquo;I am incredibly impressed with this real estate app! The user-friendly interface makes searching for properties a breeze, and the mortgage calculator provided valuable insights into my financial options. The ability to connect with a knowledgeable agent right from the app added a personal touch to my home-buying journey. I highly recommend this app to anyone looking for a seamless and informative real estate experience.&rdquo;
                    </p>
                  </blockquote>
              ...
              <div class="item">
                <div class="testimonial">
                  ...
                  <blockquote>
                    <p>
                      &ldquo;Absolutely thrilled with this real estate app! The vast range of properties available exceeded my expectations. The analytics feature provided valuable market insights, helping me make informed decisions. Connecting with an agent through the app was seamless, making the entire process convenient and stress-free. A must-have for anyone serious about finding their dream home&rdquo;
                    </p>
                  </blockquote>
              ...
              <div class="item">
                <div class="testimonial">
                  ...
                  <blockquote>
                    <p>
                      &ldquo;Kudos to the creators of this real estate app! The mortgage calculator feature made it easy for me to understand my financial options. The range of properties is impressive, and the analytics provided a deeper understanding of the market. The ability to connect with a knowledgeable agent through the app was a game-changer. This app truly exceeded my expectations!&rdquo;
                    </p>
                  </blockquote>
