<x-app-layout>
    <section>
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                ...
                <div class="lg:py-24">
                    <h2 class="text-3xl font-bold sm:text-4xl">Advertise your property</h2>

                    <p class="mt-4 text-gray-600">
                        Unlock Your Property's Potential - Advertise with Us for Unmatched Visibility and Results! Reach the Right Buyers Faster and Maximize Your Property's Value. Join the Leading Platform for Real Estate Success Today!
                    </p>
    ...
    <section class="relative py-32 lg:py-36 bg-white">
        <div
            ...
            lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
                ...
                <h1 class="text-justify text-teal-900
            font-bold ">
    ...
    <section class="p-3">
        ...
        <div class="px-6 pt-6 pb-12 -mt-12 lg:px-20 xl:px-28">
                    ...
                    <div class="p-4 text-center">
                        ...
                        <ul class="flex flex-col items-center justify-start gap-2 pt-4 mt-2 mb-4">
                            <li class="flex items-center gap-2 py-1 text-gray-700">
                                ...
                                <p class="block antialiased font-sans text-sm leading-relaxed font-normal text-inherit">Perfect for one-time sellers</p>
                            </li>
                            <li class="flex items-center gap-2 py-1 text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" class="w-5 h-5 text-inherit">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"></path>
                                </svg>
                                <p class="block antialiased font-sans text-sm leading-relaxed font-normal text-inherit">Limited support</p>
                            </li>
                        </ul>
                        <a href="/paypal-test-checkout" class="mt-6 mx-auto bg-black hover:bg-blue-700 text-white px-3 py-2 rounded inline-block">Join</a>
                    </div>
                </div>
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md lg:h-max lg:scale-100 z-10 translate-y-0">
                    <div class="p-4 text-center">
                        ...
                        <ul class="flex flex-col items-center justify-start gap-2 pt-4 mt-2 mb-4">
                            <li class="flex items-center gap-2 py-1 text-gray-700">
                                ...
                                <p class="block antialiased font-sans text-sm leading-relaxed font-normal text-inherit">Perfect for real-estate agents</p>
                            </li>
                            <li class="flex items-center gap-2 py-1 text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" class="w-5 h-5 text-inherit">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"></path>
                                </svg>
                                <p class="block antialiased font-sans text-sm leading-relaxed font-normal text-inherit">24/7 support</p>
                            </li>
                    ...
                    <div class="p-4 text-center">
                        ...
                        <ul class="flex flex-col items-center justify-start gap-2 pt-4 mt-2 mb-4">
                            <li class="flex items-center gap-2 py-1 text-gray-700">
                                ...
                                <p class="block antialiased font-sans text-sm leading-relaxed font-normal text-inherit">Perfect for enterprises</p>
                            </li>
                            <li class="flex items-center gap-2 py-1 text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" class="w-5 h-5 text-inherit">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"></path>
