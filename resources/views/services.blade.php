<x-app-layout>
    ...
    <section class="p-4">
        ...
        <div class="relative  bg-black text-gray-700 flex h-full min-h-[314px] w-full flex-col items-center justify-center rounded-xl bg-gray-900 px-8">
            <div class="container mx-auto text-center">
                ...
                <p class="block antialiased font-sans text-xl font-normal leading-relaxed text-white mb-8 opacity-70">Invest in Success - Our Competitive Pricing Ensures Maximum Exposure for Your Property at the Best Value. Discover Affordable Packages Tailored to Meet Your Advertising Needs!</p>
            </div>
        </div>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md lg:h-max lg:scale-105 z-10 translate-y-0">
                    <div class="p-6 text-center">
                        <h5 class="antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-green-500 flex justify-center mt-2 mb-2">Personal Plan</h5>
                ...
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md lg:h-max lg:scale-105 z-10 translate-y-0">
                    <div class="p-6 text-center">
                        <h5 class="antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-green-500 flex justify-center mt-2 mb-2">Ultimate Plan</h5>
